...
# passando um dict , o dict tem que ter extamente os argumentos da funcao
salvar_carro(**{"marca": "Fiat", "modelo": "Palio", "ano": 1999, "placa": "ABC-1234"})

'''
*args - deve receber uma tupla
**kwargs - deve receber um dicionario
